import { BufferGeometry, BufferAttribute, Vector3 } from "./three.module.js";
...
class RoundedBoxGeometry extends BufferGeometry {
  constructor(width, height, depth, radius, radiusSegments) {
    ...
    var positions = new BufferAttribute(
      new Float32Array(totalVertexCount * 3),
      3
    );

    var normals = new BufferAttribute(
      new Float32Array(totalVertexCount * 3),
      3
    );
